...
namespace Buytech.Eticaret.UI.WEB.Areas.Admin.Controllers
{
    public class CategoriesController : AdminControllerBase
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,IsActive,CreateDate,UpdateDate")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,IsActive,CreateDate,UpdateDate")] Category category)
        {
            if (ModelState.IsValid)
            {
